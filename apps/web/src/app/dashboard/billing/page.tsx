...
export default function BillingPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      {/* Current Plan Card */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-dark-900 to-dark-700 p-6 text-white shadow-sm">
        <div className="relative z-10">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="text-xl font-bold mb-1">Başlangıç Planı</h2>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <div className="flex items-center gap-2.5 mb-5">
          ...
          <h2 className="text-base font-bold text-gray-900">Ödeme Yöntemi</h2>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Son kullanma: 12/27</p>
            </div>
          </div>
          <Button
            variant="outline"
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2.5 px-6 py-5 border-b border-gray-50">
          ...
          <h2 className="text-base font-bold text-gray-900">Fatura Geçmişi</h2>
        </div>

        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50/80 hover:bg-gray-50/80">
              <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Fatura No</TableHead>
              <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Dönem</TableHead>
              <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Tutar</TableHead>
              <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Durum</TableHead>
              <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Son Ödeme</TableHead>
              <TableHead className="text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">İndir</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={6} className="py-16 text-center">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-sm font-semibold text-gray-600 mb-1">Henüz fatura yok</p>
                    <p className="text-xs text-gray-400">Ödeme geçmişiniz burada görünecek.</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
              invoices.map((invoice) => (
                <TableRow key={invoice.id} className="hover:bg-gray-50/60 border-gray-50">
                  <TableCell className="font-mono text-sm text-gray-700">{invoice.invoice_number}</TableCell>
